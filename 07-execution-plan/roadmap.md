...
```mermaid
gantt
  title 12 To 18 Month Launch Path
  dateFormat  YYYY-MM-DD
  axisFormat  %b %Y
  section Blueprint
  Plan scaffold and assumptions      :done, p0, 2026-05-02, 30d
  Screening criteria and outreach    :p1, after p0, 45d
  section First Partner
  Owner search and fit calls         :p2, after p1, 60d
  Baseline and pilot agreement       :p3, after p2, 45d
  90-day operating pilot             :p4, after p3, 90d
  section Launch Proof
  12-18 month improvement plan       :p5, after p4, 270d
  Transition or acquisition decision :milestone, m1, after p5, 0d
  section Platform
  Add-on trade screening             :p6, after p5, 90d
```
